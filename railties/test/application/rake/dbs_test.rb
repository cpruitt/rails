...
module ApplicationTests
  module RakeTests
    class RakeDbsTest < ActiveSupport::TestCase
      ...
      test "db:create and db:drop respect environment setting with multiline ERB" do
        app_file "config/database.yml", <<-YAML
          development:
            database: <%=
      ...
      test "db:create and db:drop respect environment setting in with YAML containing multiline and split erb" do
        app_file "config/database.yml", <<-YAML
          development:
          <%
      ...
      test "db:create and db:drop respect environment setting in YAML containing multiple erb statements on the same line" do
        app_file "config/database.yml", <<-YAML
          development:
